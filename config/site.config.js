...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'support@zthz.net',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Natnata9',
    },
  ],
  ...
  opds: {
    enabled: false,
    title: "ZTHZ's OneDrive",
    description: 'Hengzheng Zhongtian',
